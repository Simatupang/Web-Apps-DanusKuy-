		...
		<?php echo form_open_multipart('CreateEvent_C/inputEvent', 'class="col-7" runat="server"'); ?>
			...
			<div style="background-color: white" class="px-5 py-4 mt-5 rounded">
				...
				<div class="form-group row">
					...
					<div class="col-sm-9">
						<input type="text" class="form-control" id="inputTitle" name="title" value="<?php echo set_value('username'); ?>">
				...
				<div class="form-group row">
					...
					<div class="col-sm-9">
						<input type="text" class="form-control" id="inputSubtitle" name="subtitle" value="<?php echo set_value('username'); ?>">
				...
				<div class="form-group row">
					...
					<div class="col-sm-9">
						<input type="text" class="form-control" id="inputTarget" name="target" value="<?php echo set_value('username'); ?>">
				...
				<div class="form-group row">
					...
					<div class="col-sm-9">
						<input type="text" class="form-control" id="datepicker" name="deadline" value="<?php echo set_value('username'); ?>">
				...
				<div class="form-group row">
					...
					<div class="col-sm-9">
						<textarea class="form-control" id="inputCaption" rows="3" name="caption" value="<?php echo set_value('username'); ?>"></textarea>
			...
			<div style="background-color: white" class="px-5 py-4 mt-5 rounded">
				...
				<div class="form-group row">
					...
					<div class="col-sm-9">
						<input type="text" class="form-control" id="inputTanggal" name="tanggal" value="<?php echo set_value('username'); ?>">
				...
				<div class="form-group row">
					...
					<div class="col-sm-9">
						<input type="text" class="form-control" id="inputWaktu" name="waktu" value="<?php echo set_value('username'); ?>">
				...
				<div class="form-group row">
					...
					<div class="col-sm-9">
						<input type="text" class="form-control" id="inputLokasi" name="lokasi" value="<?php echo set_value('username'); ?>">
				...
				<div class="form-group row">
					...
					<div class="col-sm-9">
						<textarea class="form-control" id="inputAbout" rows="3" name="about" value="<?php echo set_value('username'); ?>"></textarea>
